...
public class Port {
	...
	// un port non spécial correspond au type de base, donc pas besoin d'ajouter une
	// nouvelle classe port général.
	...
	public void setOrientation(Cardinal o) {
		this.orientation = o;
	}
