...
public class Plateau {
    ...
    public Plateau() {
        ...
        this.routesVerticales = new String[7][7];
        for (int i = 0; i < 7; i++) {
            for (int j = 0; j < 7; j++) {
    ...
    public void afficherPlateau() {
        ...
        // pour la gestion des ports, on consid�re qu'ils seront g�r�s sur une Array
        // list ind�pendante et qu'ils seront r�partis al�atoirement et ce en utilisant
        // un incr�ment.
        String init = "		";
        String porttop = "~~~/���������\\~~";
        String portgauche = "~~~~\"\"\"\"\"\"\"\"\"\"\"//";
